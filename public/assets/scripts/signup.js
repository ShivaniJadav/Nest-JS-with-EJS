function togglePassword(type) {
  ...
  function validateForm() {
    ...
    if (!chkterms.checked) {
      event.preventDefault();
      chkError.textContent = 'Please read and accept the terms!';
    } else {
  ...
  // document.getElementById('chkterms').addEventListener('change', validateForm);
  // document.getElementById('txtConfirmPassword').addEventListener('change', validateForm);
  // document.getElementById('txtPassword').addEventListener('change', validateForm);
